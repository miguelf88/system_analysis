...
arcpy.CalculateFields_management(in_table=table,
                                 ...
                                 fields=[["total_pop_intersect", "!demographic_data_total_pop! * (!Shape_Area!/!na_va_tracts_tract_area!)"],
                                         ...
                                         ["no_vehicle_pop_intersect", "!demographic_data_no_vehicle_pop! * (!Shape_Area!/!na_va_tracts_tract_area!)"],
                                         ...
                                         ["poverty_pop_intersect", "!demographic_data_poverty_pop! * (!Shape_Area!/!na_va_tracts_tract_area!)"],
                                         ["total_hh_intersect", "!demographic_data_total_households! * (!Shape_Area!/!na_va_tracts_tract_area!)"],
...
arcpy.Dissolve_management(table, output_table,
                          statistics_fields=[["total_pop_intersect", "SUM"],
                                             ...
                                             ["no_vehicle_pop_intersect", "SUM"],
                                             ["under18_pop_intersect", "SUM"],
                                             ["over65_pop_intersect", "SUM"],
                                             ["poverty_pop_intersect", "SUM"],
